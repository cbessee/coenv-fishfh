...
git clone
mv coenv-fishfh your-theme-name
cd your-theme-name
...
Grunt will recomplie and minifiy your sass files into a single stylesheet
...
## Script Folder Strucutre
  ...
  * `bower_components/`: This is the source folder where all Foundation scripts are located.
